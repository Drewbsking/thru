...
SELECT
  ...
  ELT(1 + MOD(base.n + 1, 7), 'Sedan', 'SUV', 'Pickup Truck', 'Truck', 'Minivan', 'Motorcycle', 'Other') AS vehicle_type,
...
SELECT
  ...
  ELT(1 + MOD(n + 2, 7), 'Sedan', 'SUV', 'Pickup Truck', 'Truck', 'Minivan', 'Motorcycle', 'Other') AS vehicle_type,
